    ...
    <div id="wrap">
        ...
        <div class="jumbotron">
            <div>
                ...
                <p>일상의 휴식<br>잔잔한 감동을 위한 플레이리스트</p>
            </div>
            <div id="buttonjumbo">
                <p><a class="btn btn-primary btn-lg" href="#" role="button">재생 <span class="glyphicon glyphicon-triangle-right"></span></a></p>
                <p><a class="btn btn-primary btn-lg" href="#" role="button"> 좋아요 <span class="glyphicon glyphicon-heart" aria-hidden="true"></span> </a></p>
            </div>
        </div><!--jumbotron-->
