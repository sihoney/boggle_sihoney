...
<p>보글 주식회사(이하 "회사”라 함)는 고객님들의 개인정보를 소중히 다루고 있습니다.
회사는 '개인정보보호법'과 ‘정보통신망이용촉진 및 정보 보호 등에 관한 법률’ 등 모든 관련 법규를 준수하며 회원님의 개인정보가 보호받을 수 있도록 최선을 다하고 있습니다. 개인정보 보호정책을 통해 이용자가 제공한 개인정보가 어떠한 용도와 방식으로 이용되며, 개인정보 보호를 위해 어떠한 방법을 통해 관리되고 있는지에 대해 알려드립니다.</p>
<h2>1. 수집하는 개인정보 항목 및 수집방법</h2>
<h3>가. 수집하는 개인정보 항목</h3>
<p>첫째, 회사는 회원가입 및 로그인, 원활한 고객상담, 각종 최적화된 서비스를 제공하기 위하여, 다음과 같은 최소한의 개인정보를 이용자의 회원가입 시 수집하고 있습니다.</p>
<ul>
<li>
<p>일반/외국인/14세미만 어린이 회원가입 시</p>
<ul>
...
<p>둘째, 모바일 서비스 이용시 단말기에 관한 정보(단말기 모델, 하드웨어 ID, 운영체제 버전정보)와 서비스 이용 기본 통계(동기화, 독서노트 기능 제공을 위한 서점 및 애플리케이션 이용 정보, 서점 내 회원 대상 또는 개인화된 맞춤 추천 기능을 위한 서점 및 애플리케이션 이용 정보)이 수집될 수 있으나, 이는 개인을 식별할 수 없는 형태입니다. 만약 서비스 이용 도중 추가적으로 개인정보 수집이 필요한 경우, 회사는 회원에게 미리 이러한 사실을 고지하고 동의를 받습니다.</p>
<p>셋째, 회사는 이용자의 페이퍼샵 주문 혹은 AS시 재화의 배송 및 원활한 고객상담을 위하여 다음과 같은 기본 정보를 수집하고 있습니다.</p>
<ul>
...
<p>일곱째, 회사는 재화 및 콘텐츠의 환불을 위해 필요한 다음 정보를 수집하고 있습니다.</p>
<ul>
<li>이름, 예금주명, 은행명, 계좌번호, 휴대전화번호, 이메일 주소</li>
</ul>
<h3>나. 개인정보 수집방법</h3>
...
<p>제화 및 컨텐츠의 제공, 맞춤 서비스 제공, 청구서 및 구매내역 발송, 컨텐츠 선물하기, 기기 간 동기화 서비스 제공, 본인인증, 구매 및 요금 결제, 요금추심 등</p>
<h3>나. 회원관리</h3>
<p>본인확인, 불량회원(보글북스 이용약관 제16조 위반 사유로 인하여 영구이용이 정지된 회원)의 부정 이용방지와 비인가 사용방지, 가입의사 확인, 분쟁 조정을 위한 기록 보존, 민원처리, 공지사항 전달</p>
<h3>다. 신규 서비스 개발 및 마케팅에의 활용</h3>
<p>신규 서비스 개발, 통계학적 특성, 이용 형태 등에 따른 맞춤형 서비스 제공, 광고 게재, 이벤트 참여기회 제공, 접속빈도 파악, 회원의 서비스 이용에 대한 통계</p>
...
<h2>5. 개인정보의 처리 위탁</h2>
<p>보글북스는 원활하고 편리한 서비스를 위하여, 최소한의 제한된 범위에서 개인정보를 외부 전문업체에 위탁하여 운영하고 있습니다. 위탁 계약시 개인정보가 안전하게 관리될 수 있도록 관련 사항들을 별도로 규정하고 있습니다.</p>
<h3>가. 국내업체</h3>
<p>&#x3C;결제></p>
<ul>
<li>
...
<li>네이버파이낸셜 주식회사</li>
<li>주식회사 카카오페이</li>
<li>엔에이치엔한국사이버결제 주식회사</li>
<li>페이레터㈜</li>
</ul>
</li>
<li>위탁업무: 결제, 구매 안전 서비스 제공</li>
...
<li>위탁업무: 회원정보, 결제정보 보관</li>
<li>보유 및 이용기간: 회원 탈퇴 및 목적 달성 시 즉시 파기</li>
</ul>
<p>&#x3C;제품 AS></p>
<ul>
<li>수탁업체: 위넥스소프트(주)</li>
<li>위탁업무: 회원정보, AS 이력 관리</li>
<li>보유 및 이용기간: 소비자의 불만 또는 분쟁처리에 관한 기록 보유 방침을 따름</li>
</ul>
<h3>나. 국외업체</h3>
<p>&#x3C;고객 문의></p>
...
<p>&#x3C;알림 및 푸시 발송></p>
<ul>
<li>수탁업체(솔루션) : AB180 AUSTRALIA PTY LTD (Braze)</li>
<li>이전되는 국가: 미국</li>
<li>위탁업무: 알림 및 푸시 발송</li>
<li>보유 및 이용기간: 목적 달성시 즉시 파기</li>
</ul>
<h2>6. 개인정보 국외 이전</h2>
<h3>1. 개인정보를 이전 받는자 : Zendesk</h3>
<ul>
...
<h3>2. 개인정보를 이전 받는자(솔루션) : AB180 AUSTRALIA PTY LTD (Braze)</h3>
<ul>
<li>이전되는 개인정보 항목 : 이메일주소</li>
<li>개인정보가 이전되는 국가 : 미국</li>
<li>이전 일시 및 이전방법 : 로그인 시 네트워크를 통한 전송</li>
<li>개인정보를 이전 받는 자의 개인정보 이용목적 : 푸시 및 알림 발송</li>
<li>개인정보를 이전 받는 자의 개인정보 보유 이용 기간 : 회원 탈퇴 시까지</li>
</ul>
<h2>7. 개인정보의 보유기간 및 회원탈퇴</h2>
<h3>가. 개인 정보의 보유 및 이용 기간</h3>
...
<h3>다. 휴면계정의 개인정보 파기절차</h3>
<ul>
<li>보글북스는 "개인정보보호법 39조의 6 및 동법 시행령 48조의 5"에 따라 보글북스 서비스에 1년 이상 로그인하지 않은 계정은 개인정보보호를 위하여 해당 회원의 개인정보를 휴면계정으로 전환 및 별도 관리합니다.</li>
<li>휴면 처리되는 회원정보 : 회원 가입 시 또는 회원 정보 수정으로 수집/관리되는 모든 정보</li>
<li>보글북스는 휴면 계정의 개인정보 분리·저장 기간이 도래하기 1개월 전에 이메일 등을 통해 해당 이용자에게 관련 내용을 공지합니다.</li>
<li>휴면 처리된 계정의 개인정보는 분리 보관 시작으로부터 4년이 경과하면 지체없이 파기합니다.</li>
</ul>
<h2>9. 쿠키에 대한 운용 및 선택권</h2>
<h3>가. 쿠키의 운용 및 사용목적</h3>
...
<h2>11. 개인정보의 기술적/관리적 보호 대책</h2>
<p>회사는 이용자들의 개인정보를 처리함에 있어 개인정보가 분실, 도난, 유출, 변조 또는 훼손되지 않도록 안전성 확보를 위하여 다음과 같은 기술적/관리적 대책을 강구하고 있습니다.</p>
<h3>가. 비밀번호 암호화</h3>
<p>보글북스 회원 아이디(ID)의 비밀번호는 암호화되어 저장 및 관리되고 있어 본인만이 알고 있으며, 개인정보의 확인 및 변경도 비밀번호를 알고 있는 본인에 의해서만 가능합니다.</p>
...
<h3>라. 개인정보 보호를 위한 노력</h3>
<p>회사는 개인정보 처리방침의 이행사항 및 담당자의 준수여부를 확인하여 문제가 발견될 경우 즉시 수정하고 바로잡을 수 있도록 노력하고 있습니다. 단, 이용자 본인의 부주의나 인터넷상의 문제로 아이디, 비밀번호, 이메일 주소 등 개인정보가 유출되어 발생한 문제에 대해 회사는 일체의 책임을 지지 않습니다.</p>
<h2>12. 개인정보 보호책임자 및 담당자</h2>
<h3>가. 개인정보 관리 및 보호의 의무</h3>
...
<ul>
<li>개인정보처리방침 버전번호 : 3.14</li>
<li>개인정보처리방침 변경 공고일자 : 2021년 12월 3일</li>
<li>변경 개인정보처리방침 시행일자 : 2021년 12월 17일</li>
</ul>
</html>